...
\begin{itemize}
    ...
    \begin{figure}[h]
        ...
        \begin{minipage}{0.45\textwidth}
            \centering
            \includegraphics[width=0.8\linewidth]{sections/chapters/Chapter6/Images/Architectures/embedding.pdf}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \centering
        ...
        \begin{minipage}{\textwidth}
            \centering
            \includegraphics[width=\linewidth]{sections/chapters/Chapter6/Images/Two-Layers-B/two_layers_B.pdf}
        \end{minipage}
    ...
    \begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
            \includegraphics[width=0.86\textwidth]{sections/chapters/Chapter6/Images/Mixed-Arch/mixed.pdf}
