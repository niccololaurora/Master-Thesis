...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.65]{sections/chapters/Chapter6/Images/Two-Layers/two_layer.pdf}
...
Each of the following sections will discuss a different size dataset ($4\times4$, $8\times8$, $12\times12$, 
$14\times14$, $16\times16$, $18\times18$).
Each section will discuss both the fashion and digit MNIST datasets for the two types of encoding.


\subsection{Images 4x4}


\subsection{Images 8x8}
